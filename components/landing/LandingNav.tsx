    ...
    <>
      <header
        className={cn(
          ...
          scrolled
            ? 'bg-[#07070f]/90 backdrop-blur-xl border-b border-white/[0.07] shadow-xl shadow-black/20'
            : 'bg-transparent',
        )}
      >
        <div className="max-w-7xl mx-auto px-5 lg:px-8 h-16 flex items-center justify-between gap-6">
          ...
          <Link href="/" className="flex items-center gap-2 shrink-0">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-500 to-blue-500 flex items-center justify-center shadow-lg shadow-blue-600/30">
          ...
          <nav className="hidden md:flex items-center gap-1">
            {NAV_LINKS.map(({ label, href }) => (
              <a
                key={label}
                href={href}
                className="px-3.5 py-2 text-sm text-white/60 hover:text-white rounded-lg hover:bg-white/[0.06] transition-all"
              >
                {label}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Link
              href="/auth/sign-up"
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#4f8ef7] hover:bg-[#3d7ef5] text-white text-sm font-semibold transition-all shadow-lg shadow-blue-600/25 hover:shadow-blue-600/40 hover:-translate-y-px"
            >
              Get started free
